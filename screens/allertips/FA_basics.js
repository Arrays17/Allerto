...
export default function FirstAidBasics() {
  return (
    <ScrollView style={s.tips}>
      <View>
          <Image
            source={require('../../assets/allertips_images/firstaid.jpg')}
            style={s.imageTip}
          />
        </View>
      ...
      <Text style={s.tipContent}>
        ...
        {'\t'} <Text style={{color: 'orange'}}>&#8226;</Text> If the child or baby does not respond and is not breathing or only gasping, immediately begin CPR, starting with compressions. Continue giving sets of 30 chest compressions and 2 breaths until:{'\n'}
        ...
        {'\t'} <Text style={{color: 'orange'}}>&#8226;</Text> Interview the child, parent or guardian{'\n'}
        {'\t'} <Text style={{color: 'orange'}}>&#8226;</Text> Do a focused check based on what the child, parent or guardian told you, how the child or baby is acting and what you see{'\n'}
      ...
      <Text style={s.tipContent}>
        ...
        {'\t'} <Text style={{color: 'orange'}}>&#8226;</Text> Interview the person (or bystanders, if necessary), ask questions about signs and symptoms, allergies, and medications and medical conditions (SAM){'\n'}
        {'\t'} <Text style={{color: 'orange'}}>&#8226;</Text> Do a focused check based on what the person told you, how the person is acting and what you see{'\n\n'}
